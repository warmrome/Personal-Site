      ...
      <Box className={styles.container}>
        <Box className={styles.leftBox}>
          <Paragraph className={styles.paragraph} size="lg">
            ...
            <br />
            <br />
            In tincidunt mi dolor, a finibus dui tristique lacinia. Aenean a
            purus lorem. Aliquam quis lobortis velit. Cras rutrum, eros at
            consectetur rutrum, nisi magna eleifend lorem, auctor porttitor
            dolor orci et risus. Sed lorem leo, faucibus nec facilisis non,
            aliquam a sem. Praesent luctus odio orci. Donec vulputate volutpat
            mauris ultrices gravida.
            <br />
            <br />
